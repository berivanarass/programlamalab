...
for key in my_d.keys():
    ...
    def my_h(list_1):
     ...
     ##################
#lookup fonksiyonu girilen değer kadar tekrar eden sayıyı döndürmemize yarar.     
     def lookup(d,v):
         for key in d:
             if d[key]==v:
                 return key
...
known = {0:0, 1:1}
def fibo_rec(n): # known u kullanarak fibonacci sayılarını bulan fonskiyon
    """
